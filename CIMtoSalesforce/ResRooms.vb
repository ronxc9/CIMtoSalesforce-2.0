...
Public Class ResRooms
    ...
    Private Sub PrepData()
        Dim qry As String
        qry = My.Computer.FileSystem.ReadAllText("\\houtils\SalesforceCSV\Application\Query.txt")
    ...
    Private Sub BuildString()
        ...
        Next
        csvString = csvString.Substring(0, csvString.Length - 1) & vbNewLine
    ...
    Private Sub DumpData()
        ...
        Dim finalPath As String = "\\HOUTILS\SalesforceCSV\CIMToSalesforce.csv"
